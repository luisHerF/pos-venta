...
export default function Layout() {
  ...
  const nav = (
    <nav className="space-y-1">
      ...
      <NavLink to="/ventas" className={linkClass}>🛒 Punto de venta</NavLink>
      <NavLink to="/inventario" className={linkClass}>📦 {template.productLabelPlural}</NavLink>
      <NavLink to="/categorias" className={linkClass}>🏷️ Categorías</NavLink>
      <NavLink to="/reportes" className={linkClass}>📈 Reportes y cortes</NavLink>
